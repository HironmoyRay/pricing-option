...
const Header = () => {
  ...
  return (
    <nav className="relative md:flex md:w-full md:justify-center bg-rose-700 text-white">
      <div
        onClick={() => {
          setOpen(!open);
        }}
      ...
      >
        <li className="hover:border-b-white hover:border-b-2 mx-2 px-6 py-1 md:my-2 rounded-xl duration-100">
          <a href="#">Home</a>
        </li>
        <li className="hover:border-b-white hover:border-b-2 mx-2 px-6 py-1 md:my-2 rounded-xl duration-100">
          <a href="#user">Users</a>
        ...
        <li className="hover:border-b-white hover:border-b-2 mx-2 px-6 py-1 my-1 md:my-2 rounded-xl duration-100">
